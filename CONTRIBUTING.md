...
This package is primarily maintained by [Prismic](https://prismic.io)[^1]. External contributions are welcome. Ask for help by [opening an issue](https://github.com/prismicio/prismic-svelte/issues/new/choose), or request a review by opening a pull request.
...
> [!NOTE]
> It's highly recommended to discuss your changes with the Prismic team before starting by [opening an issue](https://github.com/prismicio/prismic-svelte/issues/new/choose).[^2]
>
> A short discussion can accellerate your work and ship it faster.

```sh
# Clone and prepare the project.
git clone git@github.com:prismicio/prismic-svelte.git
cd prismic-svelte
npm install
...
npm install package_name@pr-101
...
This repository uses [Release Please](https://github.com/googleapis/release-please). To publish changes in `master`, merge [the pending Release Please PR](https://github.com/prismicio/prismic-svelte/pulls?q=is%3Apr+is%3Aopen+label%3A%22autorelease%3A+pending%22).
